#' A generic SEM algorithm
#' @description A generic SEM algorithm that can work on specific models/classes,
...
#' The default is NULL.  
#' @return the fitting object for the model with the class `em` and `sem`.
#' @export
sem <- function(model, ..., latent=2, verbose=F,
